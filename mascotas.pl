...
perros:-pregunta('¿Prefieres que tu compañero sea perro?').
...
pequena:-pregunta('¿te gustan los animales pequeños?').
...
preguntar(Problema):- new(Di,dialog('Test')),
     new(L2,label(texto,'pronto sabras quien sera tu compañero, solo contesta estas preguntas...')),
